// One-shot helper: seed the /press/launch page as a `pressRelease` document
// (the new dedicated type) so the redesigned press layout is live and the
// editor has a filled example to work from.
//
// Reuses the press portraits + red hero already uploaded in
// scripts/upload-press-photos.mjs / publish-press-pages.mjs.
//
// Safe to re-run: it createOrReplaces a fixed _id.
//
// Usage: node --env-file=.env scripts/seed-press-launch.mjs
...
// Assets already in the dataset.
const HERO_ASSET = "image-a3f841715e6c4064b29df2dc0e37a24d5c2d7fc1-1376x768-jpg";
const JENS_ASSET = "image-f7944ad85c1ea1da760c735475ba0ddd75e7bbcc-2000x3000-jpg";

function para(key, text) {
  return {
    _type: "block",
    _key: key,
    style: "normal",
...
const body = [
  ...
  para("b4",
    "To help lead that transformation, Brigada has appointed Senta Slingerland as Chief Strategy Officer. Slingerland brings international experience in strategy, innovation and transformation, having worked with organisations including Coca-Cola, Accenture Song, Google and Amazon."),
  para("b5",
  ...
  para("b6", "The agency launches with a simple belief: Sharp Beats Loud."),
  quote("q4",
    ...
    "Senta Slingerland", "Chief Strategy Officer, Brigada"),
  para("b7", "Brigada exists to change that."),
];

const doc = {
  _id: "pressRelease-launch",
  _type: "pressRelease",
  title: "Press launch — Brigada",
  slug: {_type: "slug", current: "launch"},
  publishDate: "2026-06-16",
  noindex: true,
  heroTitle: "Mortierbrigade and five sister agencies launch Brigada",
  heroImage: {
    _type: "image",
    alt: "The Brigada team — Brussels, May 2026",
    asset: {_type: "reference", _ref: HERO_ASSET},
  },
  body,
  portrait: {
    _type: "image",
    alt: "Jens Mortier, founder of mortierbrigade and Creative Chairman of Brigada",
    asset: {_type: "reference", _ref: JENS_ASSET},
  },
  portraitCaption: "Jens Mortier, Creative Chairman of Brigada",
  pressKit: [
    {_type: "download", _key: "dl-logo", label: "Logo package", meta: "SVG · PNG · EPS"},
    {_type: "download", _key: "dl-video", label: "Launch video", meta: "MP4 · 1080p"},
    {_type: "download", _key: "dl-images", label: "Press images", meta: "ZIP · high-res JPG"},
  ],
  seo: {
...
console.log("Seeding pressRelease /press/launch …");
await client.createOrReplace(doc);
console.log("  ok — /press/launch now renders the new pressRelease layout.");
console.log("  (noindex=true — flip it off in Studio when the embargo lifts.)");
console.log("  Upload real press-kit files on the document's 'Press kit' tab.");
