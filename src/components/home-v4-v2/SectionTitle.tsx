...
const SectionTitle = ({ text = "Selected Work." }: Props) => {
  ...
  useEffect(() => {
    ...
    const compute = () => {
      ...
      // Start moving as soon as the title enters the viewport (top edge at
      // bottom of viewport), finish when the top edge reaches the top.
      const start = vh; // rect.top value where progress = 0
  ...
  return (
    ...
    >
      <div className="grid grid-cols-6 gap-4 md:gap-6">
        <div
          ref={innerRef}
          className="col-span-6 font-serif font-medium leading-[0.85] text-[#2D2928] whitespace-nowrap will-change-transform"
          style={{
